...
## BASE IMAGE ##
################
FROM centos:centos8.2.2004 as base
...
ADD https://www-eu.apache.org/dist/maven/maven-3/${M2_VERSION}/binaries/apache-maven-${M2_VERSION}-bin.tar.gz .
...
#ENV BASE_DIR=/opt/${USER}
#
#COPY --from=build --chown=${USER}:${USER}</path/to/fat-jar> ${BASE_DIR}/bin
