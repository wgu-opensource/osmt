...
class SearchController @Autowired constructor(
    ...
    @PostMapping(path = [RoutePaths.Latest.SEARCH_COLLECTIONS, RoutePaths.V2.SEARCH_COLLECTIONS, RoutePaths.Unversioned.SEARCH_COLLECTIONS],
    ...
    @PostMapping(RoutePaths.V2.SEARCH_SKILLS, produces = [MediaType.APPLICATION_JSON_VALUE])
    @ResponseBody
    fun searchSkillsV2(
            uriComponentsBuilder: UriComponentsBuilder,
            @RequestParam(required = false, defaultValue = PaginationDefaults.size.toString()) size: Int,
        ...
        // build up current uri with path and params
        uriComponentsBuilder
                .path(RoutePaths.V2.SEARCH_SKILLS)
                .queryParam(RoutePaths.QueryParams.FROM, from)
                .queryParam(RoutePaths.QueryParams.SIZE, size)
                .queryParam(RoutePaths.QueryParams.STATUS, status.joinToString(",").toLowerCase())
        sort?.let { uriComponentsBuilder.queryParam(RoutePaths.QueryParams.SORT, it) }
    ...
    @PostMapping(RoutePaths.V2.COLLECTION_SKILLS, produces = [MediaType.APPLICATION_JSON_VALUE])
    @ResponseBody
    ...
    @GetMapping(path = [RoutePaths.Latest.SEARCH_JOBCODES_PATH, RoutePaths.Unversioned.SEARCH_JOBCODES_PATH, RoutePaths.V2.SEARCH_JOBCODES_PATH,],
            produces = [MediaType.APPLICATION_JSON_VALUE])
    @ResponseBody
    fun searchJobCodes(
        uriComponentsBuilder: UriComponentsBuilder,
    ...
    @GetMapping(path = [RoutePaths.Latest.SEARCH_KEYWORDS_PATH, RoutePaths.Unversioned.SEARCH_KEYWORDS_PATH, RoutePaths.V2.SEARCH_KEYWORDS_PATH],
            produces = [MediaType.APPLICATION_JSON_VALUE])
    @ResponseBody
    fun searchKeywords(
        uriComponentsBuilder: UriComponentsBuilder,
