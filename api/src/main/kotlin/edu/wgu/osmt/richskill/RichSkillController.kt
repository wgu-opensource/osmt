...
class RichSkillController @Autowired constructor(
    ...
    fun createSkills(
        ...
        val task = CreateSkillsTask(apiSkillUpdates, oAuthHelper.readableUsername(user), oAuthHelper.readableEmail(user))
    ...
    fun updateSkill(
        ...
        val updatedSkill =
            richSkillRepository.updateFromApi(existingSkill.id.value, skillUpdate, oAuthHelper.readableUsername(user), oAuthHelper.readableEmail(user))
                ?: throw ResponseStatusException(HttpStatus.NOT_FOUND)
