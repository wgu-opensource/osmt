...
export class FormFieldKeywordSearchMultiSelect
  extends AbstractFormFieldSearchMultiSelect<IAlignment|INamedReference|string> {
  ...
  protected callSearchService(text: string): Observable<(IAlignment|INamedReference|string)[]> {
    ...
    let transformFn = (r: INamedReference): IAlignment|INamedReference|string|undefined => r
